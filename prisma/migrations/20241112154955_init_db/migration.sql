...
-- CreateEnum
CREATE TYPE "TransictionPaymentMethod" AS ENUM ('CREDIT_CARD', 'DEBIT_CARD', 'BANK_TRANSFER', 'BANK_SLIP', 'CASH', 'PIX', 'OTHER');
...
CREATE TABLE "transaction" (
    ...
    "paymentMethod" "TransictionPaymentMethod" NOT NULL,
